...
contract HydrexBasePluginFactory is IHydrexBasePluginFactory {
    ...
    /// @inheritdoc IHydrexBasePluginFactory
    function createPluginForExistingPool(address token0, address token1) external virtual override returns (address) {
    ...
    function _createPlugin(address pool) internal returns (address) {
        ...
        address plugin =
            address(new HydrexBasePlugin(pool, algebraFactory, address(this), defaultFeeConfiguration, defaultBaseFee));
