...
abstract contract VolatilityOraclePlugin is AlgebraBasePlugin, IVolatilityOracle {
    ...
    uint8 private constant VOLATILITYORACLEPLUGIN_CONFIG = uint8(Plugins.AFTER_INIT_FLAG | Plugins.BEFORE_SWAP_FLAG);
    ...
    function _initialize_TWAP(int24 tick) internal {
        ...
        _enablePluginFlags(VOLATILITYORACLEPLUGIN_CONFIG);
    }
        ...
        returns (int56 tickCumulative, uint88 volatilityCumulative)
    {
        ...
        VolatilityOracle.Timepoint memory result =
            timepoints.getSingleTimepoint(_blockTimestamp(), secondsAgo, tick, lastTimepointIndex, oldestIndex);
